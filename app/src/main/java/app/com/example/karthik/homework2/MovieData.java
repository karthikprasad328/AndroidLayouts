...
public class MovieData {
    ...
    public MovieData(){
        ...
        moviesList.add(createMovie("The Dark Knight", R.drawable.dark_knight, description, year, length, rating, director, stars, url));
		year = "1999";
		length = "136 min";
		rating = 6.6;
        ...
        moviesList.add(createMovie("The Dark Knight Rises", R.drawable.dark_knight_rises, description, year, length, rating, director, stars, url));
		year = "2004";
		length = "93 min";
		rating = 7.3;
